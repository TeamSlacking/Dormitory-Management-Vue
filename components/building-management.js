import { BuildingTableRow } from "./building-management-table-row.js";
                    ...
                    <div class="card-header index-card-header">
                        ...
                        <form action="#" id="search_form" class="form-inline">
                            <div class="mb-2 mr-sm-2">
                                <input v-model="searchForm.name" type="text" class="form-control" placeholder="名称" />
                            </div>
                        </form>
                            ...
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                <tbody class="text-center">
                                    ...
                                    <tr v-if="addModel">
                                        ...
                                        <td><input v-model="newData.bio" class="form-control" type="text" style="width: 83px" /></td>
                                        <td><input v-model="newData.admin" class="form-control" type="number" style="width: 145px" /></td>
                                        <td>
